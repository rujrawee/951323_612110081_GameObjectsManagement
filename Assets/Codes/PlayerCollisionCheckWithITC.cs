    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if(itc != null)
        {
            switch(itc.Type)
            {
                ...
                break;
                case ItemType.JK_Obstacle:
                _textPickUpInfo.text = "JK_OBSTACLE has been picked up";
                break;
                case ItemType.Test_OBSTACLE:
                _textPickUpInfo.text = "Test_OBSTACLE has been picked up";
                break;
            }
        }
    }
